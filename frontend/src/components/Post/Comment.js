...
function Comment(props) {
    ...
    //props.user_id is actually primary key ID on database. so we gotta stupidly
    ...
    useEffect(() => {
        console.log("printing out useEffect");
    ...
    const modifiedDate = props.date.substring(0, 10) + " " + props.date.substring(11, 16)
